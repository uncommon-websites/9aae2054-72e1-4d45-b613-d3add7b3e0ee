...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Sarah Chen",
		role: "Founder & CEO",
		image: "/generated/image-a-professional-asian-entrepreneur-stands.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I spent three years flying between Seoul and Los Angeles, watching brilliant manufacturers struggle to reach buyers who needed them. The friction wasn't just inefficient—it was keeping the world's best fashion innovation locked away. We're changing that."`}
			/>
